...
public abstract class Enemy extends Obj {
	protected int hp; // 生命�?	protected int maxHp; // 最大生命�?
	...
	/**
 * 更新敌人状�? * @since 2026-01-19 基类提供基本移动和存活检�? */
	@Override
	public void update() {
		super.update();
	...
	/**
 * 渲染敌人 - @since 2026-01-19 使用中心原点坐标�? * @param g 图形上下�? * @since 2026-01-19 基类提供基本渲染,子类可自定义渲染
 */
	@Override
 ...
 * @param g 图形上下�? * @param screenX 屏幕X坐标
 * @param screenY 屏幕Y坐标
 * @since 2026-01-19 在敌人上方显示生命�? */
	protected void renderHealthBar(Graphics2D g, float screenX, float screenY) {
		...
		// 生命�?		float hpPercent = (float)hp / maxHp;
	...
	/**
 * 受到伤害
 * @param damage 伤害�? * @since 2026-01-19 处理伤害逻辑
 */
	...
	/**
 * 死亡回调 - 子类可重�? * @since 2026-01-19 敌人死亡时触�? */
	protected void onDeath() {
		// 子类可以重写此方法添加死亡特效、掉落物�?	}

	/**
 * 检查是否越�?- @since 2026-01-19 使用中心原点坐标�? * @param canvasWidth 画布宽度
